...
exports.run = (client, message, args) => {
  ...
  if (!time) return message.reply('Tu dois mettre une durée pour utilisé le lockdown, heures, minutes, secondes.');
...
exports.help = {
  name: 'lockdown',
  description: 'Bloque un channel pendant un certain temps',
